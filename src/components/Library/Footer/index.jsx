...
export default function Footer() {
  ...
  return (
    <footer className="fixed lg:bottom-0 bottom-[17vh] left-0 w-full lgx:h-5 h-auto z-12 flex justify-center items-center font-500 text-[1.2rem] md:px-5 px-[2rem]">
